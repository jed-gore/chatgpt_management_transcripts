...
As I feared, the RF model classed the majority of management statements as "guidance".  This is a Type 1 Error which probably falls out from the verbosity inherent in ChatGPT (which is famously known for making things up).  
  
That is to say, ChatGPT has all the faults of its qualities.
